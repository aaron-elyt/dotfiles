...
# -----------------------------------------------------
# Update Starship colors only
# -----------------------------------------------------

echo ":: Update Starship colors with wallust"
if [ -f $HOME/.config/wallust/update-starship-colors.sh ]; then
    $HOME/.config/wallust/update-starship-colors.sh
else
    echo ":: Starship color update script not found"
fi
